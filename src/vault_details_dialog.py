...
class VaultDetailsDialog(VaultEntryDialog):
    ...
    def __init__(self, parent, index, account):
        ...
        # we need to explicitly disable it here.
        ...
        #user_info_btn.clicked.connect(lambda: QMessageBox.information(self, "Title", "Message text", QMessageBox.Ok))
...
if __name__ == '__main__':
    ...
    rec = account_manager.OtpRecord("Figma","billy@gmail.com","AB34 CD56 EF77")
    acct = rec.toAccount()
